...
function App() {
  ...
  // Legacy dialog (not used). Keeping the state commented to avoid linter error.
  ...
  // Deprecated handler: SettingsDialog handles persistence directly
      ...
      <ToastProvider>
        <ToastContext.Provider value={{ showToast }}>
          <div className="relative app-container">
            {/* Menu Bar - Always visible at the top */}
            <MenuBar />
          ...
          {/* Settings Dialog - Now handled by Sidebar */}
