  ...
  <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-600/30 rounded-xl p-6">
    ...
    {isLoading ? (
      <div className="flex items-center gap-3 py-8">
        ...
        <p className="text-slate-300">Extracting problem statement...</p>
      </div>
    ) : (
...
const SolutionSection = ({
  ...
  return (
    <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-600/30 rounded-xl p-6 relative">
      <div className="flex items-center justify-between mb-4">
        ...
        {!isLoading && (
          <div className="flex items-center gap-2">
            <span className="px-3 py-1 bg-blue-500/20 text-blue-300 rounded-full text-sm font-medium font-mono">
              {currentLanguage}
            </span>
            <button
              onClick={copyToClipboard}
              className="px-3 py-1 text-sm text-white bg-green-500/20 hover:bg-green-500/30 border border-green-500/30 rounded-lg transition-colors"
            >
      ...
      {isLoading ? (
        <div className="flex items-center gap-3 py-8">
          ...
          <p className="text-slate-300">Generating solution...</p>
        </div>
      ) : (
          ...
          <div className="max-w-6xl mx-auto p-6">
            ...
            <div className="mb-8">
              ...
              <p className="text-slate-400">
                Here's your AI-powered solution! Review, copy, and ace your
                interview.
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <SolutionCommands
                onTooltipVisibilityChange={() => {}} // No-op to prevent flickering
